...
for(var i=0; i<pokémon.length; i++) {
    if(pokémon[i].types[1] == null && pokémon[i].types[0] == 'poison') {
        console.log(pokémon[i].name);
    }
}
...
console.log('only type poison - reverse')

for(var i=0; i<pokémon.length; i++) {
    if(pokémon[i].types[1] == null && pokémon[i].types[0] == 'poison') {
        console.log(missieElliot(pokémon[i].name));
    }
}

function missieElliot(str) {
    var dropDown = str.split("");
    console.log(dropDown);
    var flipIt = dropDown.reverse();
    console.log(flipIt);
    var reverseIt = flipIt.join("");
    return reverseIt;
}
